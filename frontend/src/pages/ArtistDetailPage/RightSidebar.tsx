...
// // src/pages/Artist/RightSidebar.tsx
...
//     <aside
//       className={
//         isNative ? "w-full px-0" : "w-80 p-4"
//       }
//     >
//       <div
//         className={
//           isNative
//             ? "bg-white rounded-2xl shadow-md p-4 flex flex-col h-[380px]"
//             : "bg-white rounded-2xl shadow p-4 flex flex-col h-[calc(100vh-6rem)]"
//         }
//       >
//         {/* 탭 선택 */}
//         <div className="flex-shrink-0 flex border-b border-gray-200 mb-2">
...
//   return (
//     <aside className={native ? "w-full" : "w-80 p-0 lg:p-4"}>
//       <div
//         className={
//           native
//             ? "rounded-2xl border border-gray-100 bg-white flex flex-col h-[320px]"
//             : "bg-white rounded-2xl shadow p-4 flex flex-col h-[calc(100vh-6rem)]"
//         }
//       >
//         {/* 탭 선택 */}
//         <div className="flex-shrink-0 flex border-b border-gray-200 mb-2 px-2">
//           <button
//             className={`flex-1 text-xs font-semibold py-2 -mb-[1px] ${
//               selectedTab === "chat"
//                 ? "text-purple-600 border-b-2 border-purple-600"
//                 : "text-gray-500 border-b-2 border-transparent"
//             }`}
...
//         <div
//           ref={scrollContainerRef}
//           className="flex-grow overflow-y-auto min-h-0 px-1"
//         >
//           {selectedTab === "chat" ? (
//             <ArtistChatTab
//               messages={messages}
...
//         {/* 채팅 입력창 */}
//         {selectedTab === "chat" && (
//           <div className="flex-shrink-0 pt-2 px-1 pb-1">
//             {isLoggedIn && isUserFollowing ? (
...
//                   onKeyDown={(e) => e.key === "Enter" && handleSend()}
//                   placeholder="메시지를 입력하세요..."
//                   className="flex-1 px-3 py-2 border rounded-full text-xs focus:outline-none focus:ring-2 focus:ring-purple-400"
//                 />
//                 <button
//                   onClick={handleSend}
//                   disabled={!newMessage.trim()}
//                   className="flex-shrink-0 w-8 h-8 bg-purple-600 hover:bg-purple-700 text-white rounded-full flex justify-center items-center disabled:bg-gray-400"
//                 >
//                   <Send size={16} />
//                 </button>
//               </div>
...
// src/pages/ArtistDetailPage/RightSidebar.tsx
import { useState, useRef } from "react";
import ArtistChatTab from "./ArtistChatTab";
import RecommendTab from "./RecommendTab";
import { Send } from "lucide-react";
...
const RightSidebar = ({ artistId }: RightSidebarProps) => {
  ...
  /* ------------------------------------------------
   * B. 앱(Capacitor) – 팬톡 페이지에서 화면 꽉 채우기
   * ------------------------------------------------ */
  return (
