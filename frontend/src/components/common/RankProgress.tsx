      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-sm text-white/80 mb-6 flex items-center gap-1">
            {roomCreateCount !== undefined ? (
              <>
                <span>{roomCreateCount.toLocaleString()}</span>
                <span>
                  {t(
                    "rankProgress.subtitle.roomCountSuffix",
                    "개 방 생성 · 참여도 등급",
                  )}
                </span>
              </>
            ) : (
              <UIText id="rankProgress.subtitle.activity">
                활동 등급
              </UIText>
            )}
            <button
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 h-1 bg-white/10 rounded-full relative">
              ...
              <div
                ...
                style={{
                  width: `${
                    (currentIndex / (RANK_ORDER.length - 1)) * 100
                  }%`,
                  backgroundColor: style.accent,
                }}
              />
                ...
                {RANK_ORDER.map((rank, idx) => {
                  ...
                  return (
                    <div
                      ...
                      style={
                        active ? { backgroundColor: style.accent } : {}
                      }
                    />
                  );
                })}
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white">
              <h2 className="flex items-center gap-2 text-base font-semibold text-gray-800">
                <img
                  ...
                  className="w-5 h-5 object-contain"
                />
                <UIText id="rankProgress.modal.title">
                  덕온 랭킹 안내
                </UIText>
              </h2>
              <button
                ...
                className="rounded-full px-3 py-1 text-sm text-gray-600 hover:bg-gray-100"
              >
                <UIText id="rankProgress.modal.close">
                  닫기
                </UIText>
              </button>
            </div>
