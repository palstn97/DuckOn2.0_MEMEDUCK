...
//                         // 1. 새로운 데이터 형식(Map)인지 확인
//                         if (uidObj instanceof Map) {
//                             @SuppressWarnings("unchecked")
//                             Map<String, Object> userMap = (Map<String, Object>) uidObj;
//                             uid = (String) userMap.get("userId");
//                         } 

//                         // 2. 그 외의 경우, 기존 데이터 형식(String)으로 간주하고 처리
//                         else {
//                             uid = String.valueOf(uidObj);
//                         }

//                         // 3. uid가 정상적으로 추출된 경우에만 공통 로직 실행
